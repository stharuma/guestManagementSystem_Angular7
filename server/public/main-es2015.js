...
let GuestAddComponent = class GuestAddComponent {
...
let GuestEditComponent = class GuestEditComponent {
    constructor(_backendService, _route) {
        this._backendService = _backendService;
        this._route = _route;
        this.error = false;
        this.errorMessage = "Something went wrong with App";
...
let GuestResultComponent = class GuestResultComponent {
    constructor(_backendService, _route, _router) {
        this._backendService = _backendService;
        this._route = _route;
...
let GuestSearchComponent = class GuestSearchComponent {
    constructor(_router) {
        this._router = _router;
    }
    ngOnInit() {
...
let HostAddComponent = class HostAddComponent {
    constructor(_backendService) {
        this._backendService = _backendService;
        this.error = false;
        this.errorMessage = "Something went wrong with App";
...
let HostEditComponent = class HostEditComponent {
    constructor(_backendService, _route) {
        this._backendService = _backendService;
        this._route = _route;
        this.error = false;
...
let HostResultComponent = class HostResultComponent {
    constructor(_backendService, _route, _router) {
        this._backendService = _backendService;
        this._route = _route;
        this._router = _router;
...
let HostSearchComponent = class HostSearchComponent {
    constructor(_router) {
        this._router = _router;
    }
    ngOnInit() {
...
let BackendService = class BackendService {
    ...
    login(formData) {
        ...
        let httpOptions = { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json', 'token': token }) };
